...
const ProgressTracker = () => {
  ...
  return (
    <div
      className={`card ${
        allCompleted
          ? 'border-green-700/50 bg-linear-to-br from-green-900/30 to-emerald-900/30'
          : 'border-blue-700/50 bg-linear-to-br from-blue-900/30 to-purple-900/30'
      }`}
    >
      ...
      {allCompleted && stats.completed > 0 && (
        <div className="mt-4 flex flex-col items-center gap-3">
          <Button onClick={handleOpenOutputFolder} className="w-80 bg-green-600 hover:bg-green-700">
